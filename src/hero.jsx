      ...
      <div className="hero-content flex-col justify-between lg:flex-row-reverse">
        ...
        <div className="p-1.5">
          ...
          <div className="flex flex-wrap gap-4 pt-8">
            <button className="btn p-5 bg-gradient-to-r from-[#4F39F6] to-[#9514FA] rounded-full text-white">
              Explore Products
            </button>

            <button className="bg-gradient-to-r from-[#4F39F6] to-[#9514FA] p-0.5 rounded-full">
